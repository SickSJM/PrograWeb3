...
//		return "redirect:/categories/list";
	...
	public String categoryTopQuantity(Map<String, Object> model) {
		model.put("listaCategorias", caService.categoryTopQuantityOrder());
		return "reports/categoryTopQuantity";
	}

	@RequestMapping("/reporte3")
	public String categoryTopFrquency(Map<String, Object> model) {
		model.put("listaCategorias", caService.categoryTopFrequencyOrder());
		return "reports/categoryTopFrequency";
	}
}
